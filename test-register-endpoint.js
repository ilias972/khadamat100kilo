...
async function testRegisterEndpoint() {
  ...
  const testCases = [
    { email: `test-perf-1-${Date.now()}@test.com`, phone: '+212600000001' },
    { email: `test-perf-2-${Date.now()}@test.com`, phone: '+212600000002' },
    { email: `test-perf-3-${Date.now()}@test.com`, phone: '+212600000003' },
    { email: `test-perf-4-${Date.now()}@test.com`, phone: '+212600000004' },
    { email: `test-perf-5-${Date.now()}@test.com`, phone: '+212600000005' }
  ];
