...
import { MapPin, Star, Shield, Crown, RotateCcw, Search } from 'lucide-react';
...
export const ProsFilters: React.FC<ProsFiltersProps> = ({
  filters,
  onFiltersChange,
  onClearFilters,
  cities,
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-12 pr-4 py-3 bg-[#EDEEEF] border-0 rounded-[24px] text-text-primary font-medium focus:outline-none focus:ring-2 focus:ring-primary-300 transition-all duration-200"
          />
        </div>
      </div>
      ...
      <div className="mb-6">
        <label className="flex items-center space-x-2 cursor-pointer">
          <input
            ...
            onChange={(e) => onFiltersChange({ onlyVerified: e.target.checked })}
      ...
      <div className="mb-6">
        <label className="flex items-center space-x-2 cursor-pointer">
          <input
            type="checkbox"
            checked={filters.onlyPremium || false}
            onChange={(e) => onFiltersChange({ onlyPremium: e.target.checked })}
            className="w-4 h-4 text-[#F97B22] border-[#EDEEEF] focus:ring-[#F97B22] focus:ring-2 rounded"
          />
