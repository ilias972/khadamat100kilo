...
exports.ProsSkeleton = void 0;
const react_1 = __importDefault(require("react"));
const ProsSkeleton = () => {
    return (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {[...Array(8)].map((_, i) => (<div key={i} className="bg-gradient-to-br from-[rgba(250,247,242,0.8)] to-[rgba(255,255,255,0.5)] backdrop-blur-sm rounded-[24px] p-6 shadow-[0_8px_24px_rgba(0,0,0,0.06)] animate-pulse">
...
exports.ProsSkeleton = ProsSkeleton;
//# sourceMappingURL=pros-skeleton.js.map