...
exports.WhyChooseKhadamat = void 0;
const react_1 = __importDefault(require("react"));
const lucide_react_1 = require("lucide-react");
const WhyChooseKhadamat = () => {
    const features = [
        {
            id: 'verified',
    ...
    return (<section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (<div key={feature.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center hover:shadow-lg hover:-translate-y-2 transition-all duration-300">
...
exports.WhyChooseKhadamat = WhyChooseKhadamat;
//# sourceMappingURL=why-choose-khadamat.js.map