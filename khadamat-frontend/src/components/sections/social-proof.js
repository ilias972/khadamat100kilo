          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="flex items-center">
                {[...Array(5)].map((_, i) => (<lucide_react_1.Star key={i} className="w-8 h-8 text-warning-500 fill-current"/>))}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              <div className="w-16 h-16 bg-success-100 rounded-3xl flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Shield className="w-8 h-8 text-success-600"/>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 rounded-3xl flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Users className="w-8 h-8 text-primary-600"/>
              </div>
              <h3 className="text-h3 font-semibold text-text-primary mb-2">
                15,000+ Artisans
              </h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-warning-100 rounded-3xl flex items-center justify-center mx-auto mb-4">
                <lucide_react_1.Award className="w-8 h-8 text-warning-600"/>
              </div>
              <h3 className="text-h3 font-semibold text-text-primary mb-2">
                Qualité Garantie
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl p-6 shadow-card">
              <div className="flex items-center mb-4">
                {[...Array(5)].map((_, i) => (<lucide_react_1.Star key={i} className="w-4 h-4 text-warning-500 fill-current"/>))}
              </div>
