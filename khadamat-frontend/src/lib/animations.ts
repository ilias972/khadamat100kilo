...
// =============================================================================
// ANIMATION PRESETS - Following warm-tech aesthetic guidelines
// =============================================================================
...
export const respectReducedMotion = (animation: Variants): Variants => {
  return {
    ...animation,
    transition: {
      ...animation.transition,
      // Will be overridden by prefers-reduced-motion media query
    }
  };
};
