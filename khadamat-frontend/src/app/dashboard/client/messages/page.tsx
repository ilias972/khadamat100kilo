...
import { MessageCard } from '@/components/dashboard/dashboard-components';
    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="flex h-screen">
          <DashboardSidebar
            userType="client"
            userName={user?.clientProfile ? `${user.clientProfile.firstName} ${user.clientProfile.lastName}` : user?.email || ''}
